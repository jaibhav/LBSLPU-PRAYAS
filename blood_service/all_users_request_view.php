<?php
    ...
    $sql_users="SELECT FNAME,LNAME,users.regno,mobno,bgrp_req,reason,req_status,userbloodrequest.created_at FROM users JOIN userbloodrequest ON users.regno = userbloodrequest.regno  ";
