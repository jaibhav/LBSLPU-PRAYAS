<?php
    ...
    $sql_users="SELECT FNAME,LNAME,users.regno,mobno,bgrp_req,reason,req_status,userbloodrequest.created_at FROM users JOIN userbloodrequest ON users.regno = userbloodrequest.regno AND users.username='$username' ";
                        ...
                        <?php
                            if(mysqli_num_rows($user_query)!==0){
                                ...
                                while($rows=mysqli_fetch_array($user_query))
                                {
                                    ...
                                    echo '<td style="word-wrap: anywhere; min-width: 200px; text-align: justify;">'.$rows['reason'].'</td>';
